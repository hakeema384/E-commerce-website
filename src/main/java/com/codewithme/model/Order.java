...
public class Order extends Product {
	...
	public Order(int orderId, int uid, int quantity, String date, int price, int branchID) {
		super();
		this.orderId = orderId;
		this.uid = uid;
		this.quantity = quantity;
	...
	public Order(int productID, String productName, String productImg,int quantity, String date) {
